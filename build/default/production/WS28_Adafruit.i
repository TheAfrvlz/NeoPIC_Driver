...
void Show()
{
    for (unsigned int PixelColor = 0; PixelColor <= 2; PixelColor++)
    {
        for (unsigned char PixelByte = 0; PixelByte <= 7; PixelByte++)
        {
            ...
            {
               { PORTD = 0x01u; { __asm("NOP"); __asm("NOP"); __asm("NOP"); __asm("NOP"); __asm("NOP"); __asm("NOP"); } PORTD = 0x00u; { __asm("NOP"); __asm("NOP"); __asm("NOP"); } }
            }
            else
            {
               { PORTD = 0x01u; { __asm("NOP"); __asm("NOP"); __asm("NOP"); } PORTD = 0x00u; { __asm("NOP"); __asm("NOP"); __asm("NOP"); __asm("NOP"); __asm("NOP"); __asm("NOP"); } }
            }
        }
    }
}
